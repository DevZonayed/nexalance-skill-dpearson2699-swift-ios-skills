...
This project is indexed by GitNexus as **swift-ios-skills** (8338 symbols, 8479 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
